...
> [!TIP]
> See also: [README-CN.md](./README-CN.md) (中文版本),
> [README-VN.md](./README-VN.md) (Phiên bản tiếng Việt),
> [README-KO.md](./README-KO.md) (한국어 버전), and
> [README-ES.md](./README-ES.md) (versión en español) for localized
> documentation with region-specific tips and best practices.
...
**Settings** (localized in English, Chinese, Vietnamese, Korean, and Spanish),
and the implementation lives in `client/src/components/Tabby/`.
...
panel is localized in English, Chinese, Vietnamese, Korean, and Spanish.
