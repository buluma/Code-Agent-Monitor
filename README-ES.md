...
El camino más rápido es **descargar un instalador precompilado** desde la [última versión de GitHub](https://github.com/buluma/Code-Agent-Monitor/releases/latest) (CI publica automáticamente una `vX.Y.Z` cada vez que `package.json` se actualiza en `master`):
