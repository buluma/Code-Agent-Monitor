...
1. **Email**: Send a detailed report to the maintainers via a private channel (open a [GitHub Security Advisory](https://github.com/buluma/Code-Agent-Monitor/security/advisories/new) on this repository).
2. **Include**:
