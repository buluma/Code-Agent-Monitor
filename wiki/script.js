...
(function () {
  const T = {
    ...
    vi: {
      ...
      "Desktop App (macOS)": "Ứng dụng máy tính (macOS)",
      ...
      "Menu-Bar (Tray) Icon": "Biểu tượng menu-bar (khay)",
    ...
    ko: {
      ...
      "Desktop App (macOS)": "데스크톱 앱 (macOS)",
      ...
      "Menu-Bar (Tray) Icon": "메뉴 바(트레이) 아이콘",
    ...
    es: {
      ...
      "Desktop App (macOS)": "Aplicación para escritorio (macOS)",
      ...
      "Menu-Bar (Tray) Icon": "Icono de Barra de Menú (bandeja)",
