...
#
PYTHONUTF8=1 python3 "C:/Users/buluma/.claude/statusline.py"
# IMPORTANT:
# Put the statusline.py file in the .claude folder in your user directory (e.g. C:/Users/buluma/.claude/statusline.py) and make sure to update the path in the above command if you place it somewhere else.
