 ...
 * - `../lib/eventBus`
 * - `../lib/api`
 * - `./ccConfig/types` — shared editor/modal state shapes
 * - `./ccConfig/Widgets` — shared read-only/editing widgets, extracted (SHA-167)
 *
 * ## Public surface
...
import type { EditorState, ConfirmDeleteState, Toast } from "./ccConfig/types";
import {
  ScopeBadge,
  CopyButton,
  Empty,
