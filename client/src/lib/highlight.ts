 ...
 * =============================================================================
 * **Path:** `/Users/buluma/Documents/GitHub/Claude-Code-Agent-Monitor/client/src/lib/highlight.ts`
 ...
 * - `canonicalLang` — exported API; see TSDoc on the symbol for behavior.
 * - `highlight` — exported API; see TSDoc on the symbol for behavior.
 * - `tokenClass` — exported API; see TSDoc on the symbol for behavior.
 *
 * ## Testing pointers
